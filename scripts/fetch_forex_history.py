"""Laedt Forex-Daily-Daten via yfinance seit 2010."""
import pandas as pd
...
def main():
    for pair_name, yf_symbol in PAIRS.items():
        ...
        # Index ist DatetimeIndex aber unnamed — explizit setzen
        df = raw.copy()
        ...
        # Forex hat oft Volume=0, das ist ok
